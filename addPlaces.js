// added missing bracket, semicolon, and double quote to fix bugs
...
function processInput() {
    "use strict"; //used strict mode to find missing var keyword for listItem variable and j counter
